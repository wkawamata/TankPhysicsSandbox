...
namespace Ui
{
    struct TrackedVehiclePanelContext
    {
        ...
        bool* mortarProfileAutoLoadAndReset = nullptr;
        ...
        std::string* mortarProfileStatus = nullptr;
        ...
        std::function<void()> saveMortarProfile;
        ...
        std::function<void()> loadMortarProfile;
        std::function<void()> loadAndApplyMortarProfile;
