...
namespace
{
    ...
    void PrintUsage()
    {
        std::cout << "Usage:\n"
                  ...
                  << "  TankPhysicsCli --test maps --map-directory Assets/Map\n"
                  ...
                  << "  TankPhysicsCli --test map --map Assets/Map/topology_course.json --tank-settings Config/tank_physics_slot1.json --settle-steps 180 --steps 300 --throttle 1 --min-forward-distance 5 --min-final-y 0\n";
    }
