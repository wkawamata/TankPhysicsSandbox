...
int main()
{
    ...
    passed &= Check(NearlyEqual(forwardInput.leftTrack, 0.0f), "straight input must use default left ratio");
    passed &= Check(NearlyEqual(forwardInput.rightTrack, 0.0f), "straight input must use default right ratio");
